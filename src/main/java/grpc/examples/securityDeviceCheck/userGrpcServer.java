...
public final class userGrpcServer {

  private userGrpcServer() {}
  ...
  public static io.grpc.MethodDescriptor<grpc.examples.securityDeviceCheck.deviceRequest,
    ...
    if ((getDeviceCheckMethod = userGrpcServer.getDeviceCheckMethod) == null) {
      synchronized (userGrpcServer.class) {
        if ((getDeviceCheckMethod = userGrpcServer.getDeviceCheckMethod) == null) {
          userGrpcServer.getDeviceCheckMethod = getDeviceCheckMethod = 
